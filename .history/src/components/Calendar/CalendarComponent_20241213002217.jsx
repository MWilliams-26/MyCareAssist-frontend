...
const CalendarComponent = ({ onGoogleSignOut }) => {
  ...
  // Handle successful login response from Google OAuth
  const handleLoginSuccess = async (response) => {
    setLoading(true);

    // Send token to backend for authentication, or use it directly to fetch user info
    ...
    try {
      ...
      // Load calendar events with the access token

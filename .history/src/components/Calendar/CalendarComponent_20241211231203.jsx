...
const CalendarComponent = ({ onGoogleSignOut, onClose }) => {
  ...
  const handleAuthClick = async () => {
    ...
    const tokenClient = window.google.accounts.oauth2.initTokenClient({
      ...
      callback: async (response) => {
        ...
        setUserName(userInfoResponse.result.name || "Google User");
        console.log("User authenticated:", userInfoResponse.result.name);
      ...
      {isModalOpen && (
        <div className="modal-overlay">
          <div className="modal-content">
            <button className="close-modal" onClose={handleModalClose}>

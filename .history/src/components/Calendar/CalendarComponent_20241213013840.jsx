      ...
      {isModalOpen && (
        <div className="modal-overlay" role="dialog" aria-labelledby="create-event-modal" aria-hidden={!isModalOpen}>
          <div className="modal-content">
            <button className="close-modal" onClick={() => setIsModalOpen(false)} disabled={events.loading}>
            ...
            <CreateEventFormModal
              ...
              accessToken={accessToken} // Pass accessToken to modal
            />
          </div>
        </div>
      )}

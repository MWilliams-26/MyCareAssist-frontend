...
function Dashboard({ profileData, doctors, handleDoctorSelect, handleCreateProfileClick, handleAddDoctorClick, handleAddEmergencyContactClick, handleAddMedicationClick }) {
  return (
            ...
            {doctors.length > 0 ? (
              <>
                ...
                <div className="dashboard__doctor-card">
                  <h3>{doctors[selectedDoctorIndex].name}</h3>
                  <p><strong>Specialty:</strong> {doctors[selectedDoctorIndex].specialty}</p>
                  <p><strong>Phone:</strong> {doctors[selectedDoctorIndex].phone}</p>
                  <p><strong>Email:</strong> {doctors[selectedDoctorIndex].email}</p>
                  <p><strong>Address:</strong> {doctors[selectedDoctorIndex].address}</p>
                  {doctors[selectedDoctorIndex].notes && (
                    <p><strong>Notes:</strong> {doctors[selectedDoctorIndex].notes}</p>
                  )}
                </div>
              </>
            ) : (

...
function Dashboard({ profileData, handleCreateProfile, onGhandleCreateProfileClick, handleAddDoctorClick, handleAddEmergencyContactClick, handleAddMedicationClick }) {
  return (

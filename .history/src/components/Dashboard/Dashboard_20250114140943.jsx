...
import DoctorCar from "../DoctorCard/DoctorCard";
      ...
      <section className="dashboard__hub">
        <div className="dashboard__hub-container">
          ...
          <div className="dashboard__hub-emergency">
            ...
            {emergencyContacts?.activeContact && (
              <div className="dashboard__emergency-card">
                <h3>{emergencyContacts.activeContact.name}</h3>
                <p><strong>Phone:</strong> {emergencyContacts.activeContact.phone}</p>
                <p><strong>Relationship:</strong> {emergencyContacts.activeContact.relationship}</p>
              </div>
            )}

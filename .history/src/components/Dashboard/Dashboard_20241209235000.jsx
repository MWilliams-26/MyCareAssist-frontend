...
function Dashboard({ profileData, handleCreateProfile, onGoogleSignOut, handleCreateProfileClick, handleAddDoctorClick, handleAddEmergencyContactClick, handleAddMedicationClick }) {
  return (

...
function Dashboard({ profileData, handleCreateProfile, onGoogleSignOuthandleCreateProfileClick, handleAddDoctorClick, handleAddEmergencyContactClick, handleAddMedicationClick }) {
  return (

...
function Dashboard({ profileData, handleCreateProfilehandleCreateProfileClick, handleAddDoctorClick, handleAddEmergencyContactClick, handleAddMedicationClick }) {
  return (
      ...
      <section className="dashboard__hub">
        <div className="dashboard__hub-container">
          ...
          <div className="dashboard__hub-profile">
            ...
            <button className="dashboard__hub-profile-btn" onClick={handleCreateProfileClick}>Create Profile +</button>
            <SetupProfile />
          </div>
          {/* Calendar Section */}

      ...
      <h2 className="welcome__features-title">Features</h2>
        <div className="welcome__features-container">
          <div className="welcome__features-doctor">
            ...
            Keep all your healthcare providers’ details in one place. Include names, specialties, contacts, and notes like insurance or office hours. Stay organized and prepared for emergencies or care coordination.
            </p>
          </div>
